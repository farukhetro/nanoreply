            ...
            <main className="container mx-auto px-4 py-12 max-w-4xl">
                <div className="prose prose-slate dark:prose-invert max-w-none">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-muted-foreground leading-relaxed mb-4">
                            ReplyBuzz implements and maintains appropriate technical and organizational measures to protect Personal Data against accidental or unlawful destruction, loss, alteration, unauthorized disclosure, or access. These measures include, but are not limited to:
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-muted-foreground leading-relaxed mb-4">
                            In the event of a Personal Data breach, ReplyBuzz shall notify the Customer without undue delay and, where feasible, no later than seventy-two (72) hours after becoming aware of the breach. The notification shall include, to the extent possible:
                        </p>
                        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                        ...
                        <p className="text-muted-foreground leading-relaxed mt-4">
                            ReplyBuzz shall cooperate with the Customer and provide reasonable assistance in investigating the breach, mitigating its effects, and complying with any notification obligations to Data Subjects or supervisory authorities.
                        </p>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-muted-foreground leading-relaxed mb-4">
                            Personal Data may be transferred to and processed in countries outside the European Economic Area (EEA) where ReplyBuzz or its Sub-processors maintain facilities. Where such transfers occur, ReplyBuzz shall ensure that appropriate safeguards are in place to protect Personal Data in accordance with Data Protection Laws.
                        </p>
                        <p className="text-muted-foreground leading-relaxed">
                            Such safeguards may include Standard Contractual Clauses approved by the European Commission, adequacy decisions, Binding Corporate Rules, or other legally recognized transfer mechanisms. Upon request, ReplyBuzz shall provide the Customer with information about the safeguards in place for international data transfers.
                        </p>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <div className="bg-muted/30 p-6 rounded-lg">
                            <p className="text-muted-foreground text-sm mb-4">
                                ReplyBuzz may engage the following categories of Sub-processors:
                            </p>
                    ...
                    <section className="mb-8">
                        ...
                        <div className="bg-muted/30 p-6 rounded-lg">
                            <p className="font-semibold mb-2">ReplyBuzz Data Protection Officer</p>
                            <p className="text-muted-foreground">Email: dpo@replybuzz.com</p>
                    ...
                    <div className="mt-12 pt-8 border-t border-border">
                        <p className="text-sm text-muted-foreground text-center">
                            This Data Processing Agreement is incorporated into and forms part of the Terms of Service between you and ReplyBuzz.
                        </p>
                    </div>
                </div>
            </main>
